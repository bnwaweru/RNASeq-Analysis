...
manual page (20). This feature in star merges and maps overlapping
paired-end reads. It is meant to improve mapping accuracy for paired-end
libraries with short insert sizes, where many reads have overlapping
mates. Star will search for an overlap between mates larger or equal to
`--peOverlapNbasesMin` bases with proportion of mismatches in the
